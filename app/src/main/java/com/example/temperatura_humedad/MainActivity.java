package com.example.temperatura_humedad;
...
public class MainActivity extends AppCompatActivity implements SensorEventListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (sensorManager.getDefaultSensor(Sensor.TYPE_AMBIENT_TEMPERATURE) != null) {
            ...
            temperatura.setText("El sensor de temperatura no está disponible");
        }
        ...
        if (sensorManager.getDefaultSensor(Sensor.TYPE_RELATIVE_HUMIDITY) != null) {
            ...
            humedad.setText("El sensor de humedad no está disponible");
        }
    }
    ...
    public void onSensorChanged(SensorEvent sensorEvent) {
        if (sensorEvent.sensor.getType() == Sensor.TYPE_AMBIENT_TEMPERATURE) {
            temperatura.setText(sensorEvent.values[0] + " °C");
        } else if (sensorEvent.sensor.getType() == Sensor.TYPE_RELATIVE_HUMIDITY) {
            humedad.setText(sensorEvent.values[0] + " %");
        }
    }
